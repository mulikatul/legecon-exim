      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown user user-menu open">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right" style="padding: 15px 0;">
            ...
            <a href="#" class="dropdown-item">              
              <div class="media">
              <i data-feather="user" class="header-custom-feather"></i>
                <div class="media-body">
                  <h3 class="dropdown-item-title">
                    Profile
                  </h3>
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              <a href="#" class="nav-link active">
                ...
                <p class="pcoded-mtext">
                  ...
                  <!-- <i class="right ion-chevron-left"></i>  -->
                </p>
              </a>
            ...
            <li class="nav-header1 navigation-label">Examples</li>
            <li class="nav-item">
            ...
            <li class="navigation-label">Miscellaneous</li>
            <li class="nav-item">
            ...
            <li class="navigation-label">Multi Level Example</li>
            <li class="nav-item">
              <a href="#" class="nav-link">
            ...
            <li class="navigation-label">Lables</li>
            <li class="nav-item">
              <a href="#" class="nav-link">
