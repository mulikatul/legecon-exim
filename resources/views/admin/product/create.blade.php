            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        <form id="quickForm" action="{{route('admin.products.store')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea type="text" name="meta_description" class="form-control" id="meta_description" placeholder="Enter meta description">{{old('meta_description')}}</textarea>
